...
class GetService
{
	 ...
	 * - currency (string): Currency is the ISO currency code for the prices, e.g. EUR or GBP. If you pass an empty currency code, it will be initialized with the catalog's currency. 
